...
let mapDispatchToProps = (dispatch) => {
  return {
    changeDialogsCont: (nameDialog) => {
      dispatch(changeNewDialogActionCreator(nameDialog));
    },
    addNewDialogCont: () => {
      dispatch(addNewDialogActionCreator());
    },
    changeMessageCont: (changeNewMessage) => {
      dispatch(changeNewMessageActionCreator(changeNewMessage));
    },
    addNewMessagesCont: () => {
